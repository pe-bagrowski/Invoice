...
class Invoice{
    ...
    public function changeUserSettings($address,$mobile,$email,$first_name,$last_name){
            $sqlInsert = "
			UPDATE ".$this->invoiceUserTable."
			SET address ='$address', mobile= $mobile, email = '$email',first_name= '$first_name',last_name= '$last_name' 				
            WHERE id =$_SESSION[userid]";

        mysqli_query($this->dbConnect, $sqlInsert)or die(mysqli_errno($this->dbConnect) . ": " . mysqli_error($this->dbConnect)) . "\n";;
    }
